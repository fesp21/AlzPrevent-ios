//
//  AdditionInfoTableTableViewController.swift
//
...
class AdditionInfoTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        Constants.userDefaults.setObject("01/01/1970", forKey: "birth")
